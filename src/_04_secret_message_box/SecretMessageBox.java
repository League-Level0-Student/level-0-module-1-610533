...
public class SecretMessageBox {
	...
	public static void main(String[] args) {
		...
		String Message = JOptionPane.showInputDialog("Say a secret message.");

		String Person2 = JOptionPane.showInputDialog("Only you can see this. What's the password?");

		if (Person2.equals(Password))
